if (navigator.serviceWorker) {
    ...
    //Giphy Cache Clean
    function giphyCacheCleaned(giphys) {
...
function update() {
    ...
    $.get(giphy.url, giphy.query)
        ...
        .done(function(res) {
            ...
            // Empty Element
            $('#giphys').empty();
            // Populate Array Of Latest Giphy
            var latestGiphys = [];
            // Loop Giphys
            ...
            //Notify The SW (If Available) Of Current Giphys
            if (navigator.serviceWorker) giphyCacheCleaned(latestGiphys);
        })
